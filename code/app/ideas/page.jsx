    ...
    <section className="w-full flex flex-col justify-center items-center h-auto bg-black text-white mt-20 mb-32">
      ...
      <div className="p-8 rounded-lg shadow-lg max-w-xl w-full">
        <div className="flex flex-col justify-center gap-6">
          ...
          <lable>Choose your field of art</lable>
          ...
          <lable>Provide keywords to receive better results</lable>

          <input
            type="text"
            value={famousPerson}
            onChange={(e) => setFamousPerson(e.target.value)}
            placeholder="Involve a famous person (optional)"
          ...
          />
          <button
            className="py-3 px-6 flex gap-2 items-center justify-center bg-blue-500 rounded-lg text-white font-bold hover:bg-blue-600 transition duration-300 ease-in-out"
            onClick={fetchIdea}
          >
            <div className="font-bold">Suggest an Idea</div>
            <img src="/stars.png" className="w-6" />
          </button>
        </div>
        {loading ? (
          <div className="flex justify-center items-center mt-6">
            <div className="w-full bg-[#080808] animate-pulse h-20 rounded-xl min-h-20">
