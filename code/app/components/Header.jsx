...
const Header = () => {
    ...
    return (
        <header className={`w-full fixed top-0 left-0 z-50 transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}>
            <nav className='flex justify-around md:justify-start items-center w-full mb-1 backdrop-blur-[0.6rem] bg-[#ffff] bg-opacity-90 border-b border-[#363636] pl-10 p-3 font-bold'>

                <a className="ml-10 " href='#'>
                    <img src="/logo.svg" alt="sum_logo" className='w-[8rem] object-contain' />
                </a>
